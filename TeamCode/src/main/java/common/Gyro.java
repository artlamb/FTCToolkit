...
public class Gyro {
    ...
    public enum GyroType {IMU, NAVX, PINPOINT}
    ...
    public Gyro (HardwareMap hardwareMap, String deviceName) {
        ...
        } else if (device instanceof GoBildaPinpointDriver) {
            initPinpoint();
    ...
    private void initPinpoint () {
        gyroType = GyroType.PINPOINT;
        pinpoint = (GoBildaPinpointDriver) device;
    }
    ...
    public double getYaw() {
        ...
        } else if (gyroType== GyroType.PINPOINT) {
            pinpoint.update();
